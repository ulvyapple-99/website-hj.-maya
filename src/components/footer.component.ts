    ...
    >
      <div class="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-8">
        ...
        <div class="md:w-1/3">
          ...
          <p class="text-sm opacity-70 leading-relaxed whitespace-pre-line">
        ...
        <div class="flex flex-col gap-2 font-medium">
           ...
           <a [href]="config().footer.facebookLink" target="_blank" class="hover:opacity-80 transition flex items-center justify-center md:justify-start gap-2" [style.color]="config().footer.style.accentColor">
